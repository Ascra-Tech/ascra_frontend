    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div class="lg:col-span-1">
          <div class="flex items-center mb-6">
            ...
            <span class="ml-2 text-xl font-bold">Ascratech</span>
          </div>
          <p class="text-gray-400 mb-6">
            Building digital excellence for tomorrow. We transform ideas into innovative software solutions that drive business growth.
          </p>
        ...
        <div>
          ...
          <ul class="space-y-3">
            ...
            <li><a href="#services" class="text-gray-400 hover:text-white transition-colors">Mobile Development</a></li>
            <li><a href="#services" class="text-gray-400 hover:text-white transition-colors">Cloud Solutions</a></li>
            <li><a href="#services" class="text-gray-400 hover:text-white transition-colors">UI/UX Design</a></li>
            <li><a href="#services" class="text-gray-400 hover:text-white transition-colors">API Development</a></li>
            <li><a href="#services" class="text-gray-400 hover:text-white transition-colors">Tech Consulting</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul class="space-y-3">
            ...
            <li class="flex items-start text-gray-400">
              ...
              <span>601, Nirmal Corporate Center<br>LBS Marg, Mulund West<br>Mumbai - 400080, India</span>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div class="border-t border-gray-800 mt-12 pt-8">
        <div class="lg:flex lg:items-center lg:justify-between">
          <div class="lg:flex-1">
            ...
            <p class="text-gray-400 mb-4 lg:mb-0">Get the latest news and updates about technology trends and our services.</p>
          </div>
      ...
      <div class="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
        <p class="text-gray-400 text-sm">
          © 2024 Ascratech. All rights reserved.
        </p>
