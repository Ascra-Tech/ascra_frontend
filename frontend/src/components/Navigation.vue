      ...
      <div class="flex justify-between h-16">
        ...
        <div class="flex items-center space-x-3">
          ...
          <button 
            ...
            class="rounded inline-flex items-center justify-center gap-2 transition-colors focus:outline-none shrink-0 text-ink-gray-8 bg-surface-gray-2 hover:bg-surface-gray-3 active:bg-surface-gray-4 focus-visible:ring focus-visible:ring-outline-gray-3 h-7 w-7 rounded"
            type="button"
            :title="theme.isDark ? 'Switch to Light Mode' : 'Switch to Dark Mode'"
          >
            <svg v-if="theme.isDark" class="lucide lucide-sun size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
            ...
            <svg v-else class="lucide lucide-moon size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
